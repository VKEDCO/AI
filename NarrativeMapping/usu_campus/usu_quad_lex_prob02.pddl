...
(define (problem usu-quad-lex-prob01)
	...
	(:init
	 ...
	 (and 
	      ...
	      (lexicalized-agent-travel-advice Agent01 Travel01 OldMain MiddleOfQuad East)
	      (lexicalized-agent-location Agent01 MiddleOfQuad)
	      (lexicalized-agent-turn-advice Agent01 Turn01 MiddleOfQuad East North)
	      (lexicalized-agent-direction Agent01 North)
	      (lexicalized-agent-travel-advice Agent01 Travel02 MiddleOfQuad AnimalSciences North)
	 ))
)
